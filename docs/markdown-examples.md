...
请参考： https://vitepress.dev/zh/guide/markdown
...
更多信息，参见 [frontmatter](https://vitepress.dev/reference/frontmatter-config)。
...
还可以在全局配置中自定义语法高亮主题、配置语言别名和自定义语言标签。有关详细信息，参见 [`markdown` 选项](https://vitepress.dev/reference/site-config#markdown)得到更多信息。
...
查看 [`markdown` 选项](https://vitepress.dev/reference/site-config#markdown) 获取更多信息。
...
请查看[配置参考：站点配置](https://vitepress.dev/reference/site-config#markdown)来获取完整的可配置属性列表。